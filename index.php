                        ...
                        <div class="modal-body">
                            <form action="index.php" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Package Type">
                                </div>
                                <div class="mb-3">
                                    <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Select Washing Point">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" aria-live="rtrim" name="description" id="description" cols="20" rows="5"></textarea>
